...
#from autoint_stpp.visualization.plotter import plot_lambst_interactive, plot_lambst_static
#from autoint_stpp.data.synthetic import STHPDataset, STSCPDataset
from abc import abstractmethod
from autoint_stpp.utils import scale_ll
...
class BaseSTPointProcess(pl.LightningModule):
    ...
    """
    #@abstractmethod
    #def calc_lamb(self, st_x, st_x_cum, st_y, st_y_cum, scales, biases,x_range, y_range, t_range, device):
    """
